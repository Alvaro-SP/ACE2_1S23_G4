	...
	const draw = (p5) => {
      ...
      let Porcentaje10 = p5.height/11;
       ...
       for(let i=0;i<11;i++){
         ...
         if(i>5){
            p5.text(`${Math.floor(Math.abs(max/5*(i-5)))}`,p5.width-(160)+5,p5.height-i*Porcentaje10-1);
         }
         if(i<5){
      ...
      for (let x = 0; x < array.length; x++) {
         ...
         if(porcentajeX*x<a){
            if(array[x]==0){
               ...
               p5.line(porcentajeX*x, (p5.height+34)/2 , porcentajeX*x,  array[x]*porcentajeY+25);
            }else{
